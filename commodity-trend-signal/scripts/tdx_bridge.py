...
# 确保 futures-data-search 路径可导入 TdxCollector
_FDS_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                         '..', 'futures-data-search')
if os.path.isdir(_FDS_PATH) and _FDS_PATH not in sys.path:
    sys.path.insert(0, _FDS_PATH)
