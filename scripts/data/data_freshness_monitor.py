...
def main():
    ...
    if cmd == 'report':
        ...
        print(f"SLA 合规率: {report['sla_coverage_pct']}%")
        print(f"[OK] 新鲜: {report['fresh']}/{report['total_varieties']} | "
              f"[x] 失败: {report['failed']}/{report['total_varieties']} | "
