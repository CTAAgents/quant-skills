...
from scripts.data_source_config import DataSourceConfig
from scripts.data_freshness_monitor import record_data_fetch
...
class MultiSourceAdapter:
    ...
    def __init__(self):
        ...
        self.cache_dir = Path.home() / ".workbuddy" / "skills" / "futures-data-search" / "data" / "cache"
